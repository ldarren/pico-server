...
onConnect = function(req, res){
    ...
    default:
        //res.writeHead(200, PICO_HEADERS);
        return res.setTimeout(DELAY_ERROR, dc, 404);
    }

    var contentType = req.headers['content-type'];

    if (-1 === contentType.toLowerCase().indexOf('multipart/form-data')){
        parseJson(req, res, reply);
    }else{
        upload(req, res, contentType, reply);
    }
},
...
session.log(res.connection.remoteAddress, channelId, orders);
